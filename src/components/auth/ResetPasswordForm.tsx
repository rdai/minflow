  ...
  if (done) {
    return (
      <div className="bg-white border border-stone-200 rounded-xl p-8 text-center">
        ...
        <p className="text-stone-600">Password updated. Redirecting...</p>
      </div>
    )
  }
  ...
  if (!ready) {
    return (
      <div className="bg-white border border-stone-200 rounded-xl p-8 text-center text-stone-400 text-sm">
        ...
        <p className="mt-3 text-xs text-stone-300">If this takes too long, the link may have expired. <a href="/login" className="text-blue-500 hover:underline">Go to login</a></p>
      </div>
    )
  }
